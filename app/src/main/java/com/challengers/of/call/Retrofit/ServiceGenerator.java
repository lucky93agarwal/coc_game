...
import static com.challengers.of.call.Retrofit.Log.LOG;

public class ServiceGenerator {

    public static String URL_WEB = "http://callofchallengers.com/";  // please web server
    ...
    public static final String API_BASE_URL = URL_WEB + "serviceManager/";
    ...
    public static <S> S createService(Class<S> serviceClass, String username, String password) {
        ...
        if (username != null && password != null) {
            ...
            Log.d("walletwallets","credentials= "+credentials);
            final String basic =
