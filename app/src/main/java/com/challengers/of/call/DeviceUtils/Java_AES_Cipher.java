...
public class Java_AES_Cipher {
    ...
    public static String encrypt(String key, String iv, String data) {
        try {
            ...
            String base64_EncryptedData = android.util.Base64.encodeToString(encryptedData, Base64.DEFAULT);
            String base64_IV = android.util.Base64.encodeToString(iv.getBytes("ISO-8859-1"), Base64.DEFAULT);
    ...
    public static String decrypt(String key, String data) {
        try {
            ...
            IvParameterSpec iv = new IvParameterSpec(android.util.Base64.decode(parts[1], Base64.DEFAULT));
            SecretKeySpec skeySpec = new SecretKeySpec(key.getBytes("ISO-8859-1"), "AES");

            Cipher cipher = Cipher.getInstance(Java_AES_Cipher.CIPHER_NAME);
            cipher.init(Cipher.DECRYPT_MODE, skeySpec, iv);

            byte[] decodedEncryptedData = android.util.Base64.decode(parts[0], Base64.DEFAULT);
