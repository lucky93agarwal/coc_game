package com.challengers.of.call.helper;

public class Constant {

    //////////////////////// POST API & PARAMETER  //////////////////////////

    public static String QUIZ_URL = "http://beedesigns.in/coc/api-v2.php"; // admin page url
    ...
    public static int MAX_QUESTION_PER_LEVEL = 5; // max question per level
    ...
    public static int CIRCULAR_MAX_PROGRESS = 11; // max progress of circular progress
    public static int TIME_PER_QUESTION = 11000;  //here we set 25 second foe each question
